// w3pi/contracts/token/data.rs

// This is the data.rs file for the token contract.
// It is used to define the data structures and functions for the token contract.
